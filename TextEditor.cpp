...
// Same singleton as Cpp(), handed back mutable so a plugin can augment it once
// (e.g. add Unreal's type/macro vocabulary + isTypeLike).
TextEditor::Language* TextEditor::Language::CppMutable()
{
	return const_cast<TextEditor::Language*>(Cpp());
}
